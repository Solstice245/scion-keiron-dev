//--------------------------------------------------------------------------------------------------
//  GenetronUpgradesHard
//--------------------------------------------------------------------------------------------------
void GenetronUpgradesHard (int player, int phase) {
    int buildType;
    ...
    if (buildType != e_buildType_Air) {
        if (phase >= c_ldPhaseMid) {
            ...
            if (phase >= c_ldPhaseLate) {
                ...
                if (AITechCount(player, c_GU_Blaze, c_techCountInProgressOrBetter) >= 5) {
...
//--------------------------------------------------------------------------------------------------
//  GenetronOpenArmyInitHard
//--------------------------------------------------------------------------------------------------
int GenetronOpenArmyInitHard (int player, int buildType) {
    int armyRoll = 0;
    int duration = 0;
    ...
    if (buildType == e_buildType_Rush) {
        ...
        if (armyRoll <= 1) {
            ...
            AIAddToStockArmy(player, c_GU_Blaze, 3);
        ...
        if (armyRoll <= 1) {
            AIAddToStockArmy(player, c_GU_Spitfire, 3);
            AIAddToStockArmy(player, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet), 4);
            // validation: 1000 resources
            duration = 380 + RandomInt(-15, 15);
        } else if (armyRoll <= 2){
            AIAddToStockArmy(player, c_GU_Spitfire, 2);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 5, c_GU_Blaze, 4);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 3, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet), 2);
        ...
        return GenetronOpenArmyInitHard(player, e_buildType_Macro);
    }
...
//--------------------------------------------------------------------------------------------------
//  GenetronOpenInitHard
//--------------------------------------------------------------------------------------------------
void GenetronOpenInitHard (int player) {
    int buildType = 0;

    AIChooseNextOpeningBuild(player);
    buildType = AIGetUserInt(player, c_openingBuildType);
    AISetupNextArmy (player, buildType, c_ldPhaseOpen, GenetronOpenArmyInitHard);

    AISetMainState(player, e_mainState_Open, e_mainSubState_Build);
}

//--------------------------------------------------------------------------------------------------
//  GenetronOpenBuildHard
//--------------------------------------------------------------------------------------------------
void GenetronOpenBuildHard (int player) {
    ...
    if (buildType == e_buildType_Rush) {
        ...
        AISetStock( player, 1, c_GB_ProcessingNode );
        ...
        AISetStock( player, 2, c_GB_ProcessingNode );
        AISetStock( player, 19, c_GU_ACR );
        AISetStockUnitNext( player, 20, c_TU_SCV, c_stockIdle );
        AISetStockFarms( player, c_GB_ProcessingNode, c_stockNormalFarms);
    }
    else if (buildType == e_buildType_Timing) {
        AISetStock( player, 1, c_GB_ProcessingCore );
        AISetStock( player, 15, c_GU_ACR );
        ...
        AISetStock( player, 1, c_GB_FilteringPlant );
        AISetStockUnitNext( player, 30, c_GU_ACR, c_stockIdle );
        AISetStockFarms( player, c_GB_ProcessingNode, c_stockNormalFarms);
        AISetStock( player, 2, c_GB_FilteringPlant );
    }
    else if (buildType == e_buildType_Air) {
    ...
    GenetronUpgradesHard(player, c_ldPhaseOpen);

    AISetStockArmyScale(player, 1.00);

    AILDStockWorkers( player, 30, c_GU_ACR);
...
//--------------------------------------------------------------------------------------------------
//  GenetronMidArmyInitHard
//--------------------------------------------------------------------------------------------------
int GenetronMidArmyInitHard (int player, int buildType) {
    int armyRoll = 0;
    int duration = 0;
    ...
    if (buildType == e_buildType_Rush) {
        ...
        AIAddToStockArmy(player, AIPickFrom2(c_GU_Spitfire, c_GU_Blaze), 2);
        ...
        AIAddToStockArmy(player, AIPickFrom2(c_GU_Spitfire, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet)), 2);
        AIAddToStockArmy(player, AIPickFrom2(c_GU_Mole_Alias, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet)), 1);
        ...
        if (armyRoll <= 1) {
            ...
            AIAddToStockArmy(player, c_GU_Blitzer, 5);
            AIAddToStockArmy(player, c_GU_Mole_Alias, 1);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 3, c_GU_Blitzer, 2);
            AIAddToStockArmy(player, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet), 2);
            AIAddToStockArmy(player, AIPickFrom2(c_GU_Mole_Alias, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet)), 1);
            ...
            AIAddToStockArmy(player, c_GU_Spitfire, 3);
            AIAddToStockArmy(player, c_GU_Blitzer, 2);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Inciter, 3, c_GU_Virtus, 2);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 3, c_GU_Blitzer, 2);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 3, c_GU_Blitzer, 2);
        ...
        if (armyRoll <= 3) {
            ...
            AIAddToStockArmy(player, c_GU_Mole_Alias, 1);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 4, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet), 2);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Mole_Alias, 2, AIPickFrom3(c_GU_Blitzer, c_GU_Equalizer, c_GU_Hornet), 3);
            ...
            AIAddToStockArmy(player, c_GU_Blitzer, 5);
            AIAddToStockArmy(player, c_GU_Mole_Alias, 1);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Mole_Alias, 2, c_GU_Blitzer, 3);
        ...
        return GenetronMidArmyInitHard(player, e_buildType_Macro);
    }
...
//  GenetronMidInitHard
//--------------------------------------------------------------------------------------------------
void GenetronMidInitHard (int player) {
    int buildType = 0;

    AIChooseNextOpeningBuild(player);
    buildType = AIGetUserInt(player, c_openingBuildType);
    AISetupNextArmy (player, buildType, c_ldPhaseMid, GenetronMidArmyInitHard);
...
//--------------------------------------------------------------------------------------------------
//  GenetronMidBuildHard
//--------------------------------------------------------------------------------------------------
void GenetronMidBuildHard (int player) {
    int buildType = AIGetUserInt(player, c_openingBuildType);
    int armyRoll = AIGetUserInt(player, c_ldNextArmyRoll);
    int timeOut = AIGetUserInt(player, c_nextArmyTime);
    bool nextState = false;
    ...
    if (AINeedsDetection(player)) {
        AISetStock( player, 1, c_GU_ProcessingDrone );
    ...
    GenetronUpgradesHard(player, c_ldPhaseMid);

    AISetStockArmyScale(player, 1.00);

    AISetStock( player, 3, c_GU_ProcessingDrone );
...
//--------------------------------------------------------------------------------------------------
//  GenetronLateArmyInitHard
//--------------------------------------------------------------------------------------------------
int GenetronLateArmyInitHard (int player, int buildType) {
    int armyRoll = 0;
    int duration = 0;
    ...
    if (buildType == e_buildType_Core) {
        ...
        if (armyRoll <= 1) {
            ...
            AIAddToStockArmy(player, c_GU_Blitzer, 5);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 3, c_GU_Blaze, 3);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blitzer, 3, c_GU_Blaze, 3);
            // validation: 2850 resources
            duration = 280 + RandomInt(-15, 15);
        } else {
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 8, c_GU_Blaze, 6);
            AIAddToStockArmy(player, c_GU_Blitzer, 6);
        ...
        if (armyRoll <= 3) {
            ...
            AIAddToStockArmy(player, c_GU_Blaze, 4);
            AIAddToStockArmy(player, c_GU_Blitzer, 6);
        ...
        if (armyRoll <= 1) {
            ...
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 4, c_GU_Blitzer, 3);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 4, c_GU_Blitzer, 3);
        ...
        if (armyRoll <= 2) {
            ...
            AIAddToStockArmy(player, c_GU_Blitzer, 9);
        ...
        return GenetronLateArmyInitHard(player, e_buildType_Core);
    }
...
//--------------------------------------------------------------------------------------------------
//  GenetronFinalArmyInitHard
//--------------------------------------------------------------------------------------------------
int GenetronFinalArmyInitHard (int player, int buildType) {
    int armyRoll = 0;
    int duration = 0;
    ...
    if (buildType == e_buildType_Core) {
        ...
        if (armyRoll <= 1) {
            AIAddToStockArmy(player, c_GU_Spitfire, 12);
            AIAddToStockArmy(player, c_GU_Blitzer, 8);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Spitfire, 4, c_GU_Blaze, 4);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blitzer, 3, c_GU_Blaze, 4);
            ...
            AIAddToStockArmy(player, c_GU_Blaze, 11);
            AIAddToStockArmy(player, c_GU_Blitzer, 10);
            AIAddToStockArmy(player, c_GU_Mole_Alias, 4);
        ...
        if (armyRoll <= 3) {
            ...
            AIAddToStockArmy(player, c_GU_Blaze, 6);
            AIAddToStockArmy(player, c_GU_Blitzer, 3);
            AIAddToStockArmy(player, c_GU_Torrent, 4);
            AIAddToStockArmy(player, c_GU_Mole_Alias, 6);
        ...
        if (armyRoll <= 1) {
            AIAddToStockArmy(player, c_GU_Spitfire, 12);
            AIAddToStockArmy(player, c_GU_Aquila, 10);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 4, c_GU_Blitzer, 3);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 4, c_GU_Blitzer, 3);
            ...
            AIAddToStockArmy(player, c_GU_Blitzer, 6);
            AIAddToStockArmy(player, c_GU_Mole_Alias, 4);
            AIAddToStockArmy(player, AIPickFrom2(c_GU_Tesla, c_GU_Jupiter), 5);
        ...
        if (armyRoll <= 2) {
            ...
            AIAddToStockArmy(player, c_GU_Blitzer, 8);
            AIAddToStockArmyPickFrom2Count(player, c_GU_Blaze, 7, c_GU_Equalizer, 5);
            AIAddToStockArmy(player, AIPickFrom2(c_GU_Boar, c_GU_Jupiter), 3);
            AIAddToStockArmy(player, AIPickFrom2(c_GU_Badger, c_GU_Virtus), 5);
        ...
        if (armyRoll <= 1) {
            ...
            AIAddToStockArmy(player, c_GU_Torrent, 4);
            AIAddToStockArmy(player, c_GU_Avenger, 2);
            AIAddToStockArmy(player, c_GU_Boar, 4);
        ...
        return GenetronFinalArmyInitHard(player, e_buildType_Core);
    }
...
//--------------------------------------------------------------------------------------------------
//  GenetronLateInitHard
//--------------------------------------------------------------------------------------------------
void GenetronLateInitHard (int player) {
    ...
    if (lateLoop <= 0) { // First Late Loop
        AISetupNextArmy (player, buildType, curPhase, GenetronLateArmyInitHard);
    } else {
        curPhase = c_ldPhaseFinal + lateLoop;
        AISetupNextArmy (player, buildType, curPhase, GenetronFinalArmyInitHard);
    }
...
//--------------------------------------------------------------------------------------------------
//  GenetronLateBuildHard
//--------------------------------------------------------------------------------------------------
void GenetronLateBuildHard (int player) {
    int lateLoop = AIGetUserInt(player, c_ldNumLateLoops);
    ...
    GenetronBasicExpansion(player, c_ldPhaseLate, 14000, 4500);
    ...
    if (buildType == e_buildType_Core) {
        ...
        AISetStockUnitNext( player, 15, c_GB_Uploader, c_stockIdle );
    }
    else if (buildType == e_buildType_HighTech) {
        if (GenetronMacroExpand(player)) { return; }
        AISetStockUnitNext( player, 2, c_GB_Manufacturer, c_stockIdle );
    ...
    AISetStock( player, 2, c_GU_ProcessingDrone );
    ...
    if (lateLoop <= 0) { // First Late Loop
        GenetronUpgradesHard(player, c_ldPhaseLate);
        GenetronTechUp(player, c_ldPhaseLate);
    } else { // Remaining Loops
        GenetronUpgradesHard(player, c_ldPhaseFinal);
...
//  GenetronOpenHard
//--------------------------------------------------------------------------------------------------
void GenetronOpenHard (int player) {
    int mainSubState = AIState(player, e_mainSubState);

    if (mainSubState != e_mainSubState_Build) {
        GenetronOpenInitHard(player);
        mainSubState = AIState(player, e_mainSubState);
    }

    if (mainSubState == e_mainSubState_Build) { GenetronOpenBuildHard(player); }
    else { ErrorMeleeScript(player, "Invalid Open MainSubState GenetronHard"); }
}

//--------------------------------------------------------------------------------------------------
//  GenetronMidHard
//--------------------------------------------------------------------------------------------------
void GenetronMidHard (int player) {
    int mainSubState = AIState(player, e_mainSubState);

    if (mainSubState != e_mainSubState_Build) {
        GenetronMidInitHard(player);
        mainSubState = AIState(player, e_mainSubState);
    }

    if (mainSubState == e_mainSubState_Build) { GenetronMidBuildHard(player);  }
    else { ErrorMeleeScript(player, "Invalid Mid MainSubState GenetronHard"); }
}

//--------------------------------------------------------------------------------------------------
//  GenetronLateHard
//--------------------------------------------------------------------------------------------------
void GenetronLateHard (int player) {
    int mainSubState = AIState(player, e_mainSubState);

    if (mainSubState != e_mainSubState_Build) {
        GenetronLateInitHard(player);
        mainSubState = AIState(player, e_mainSubState);
    }

    if (mainSubState == e_mainSubState_Build) { GenetronLateBuildHard(player);  }
    else { ErrorMeleeScript(player, "Invalid Late MainSubState GenetronHard"); }
}
